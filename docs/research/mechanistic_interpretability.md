...
`docs/ARCHITECTURE.md` §8 for the full architectural derivation). This
...
> `scripts/run_interpretability_study.py`. Placeholders are
...
[to be filled by scripts/run_interpretability_study.py]
